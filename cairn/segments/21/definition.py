...
maker = evans.SegmentMaker(
    ...
    name_staves=True,
    fermata_measures=cairn.fermata_measures_21,
    commands=[
        # evans.attach(
        #     "Global Context",
        ...
        evans.MusicCommand(
            ...
            evans.note(),
            evans.Attachment(
                evans.AfterGraceContainer("e16"),
                selector=lambda _: abjad.select.leaf(_, -1),
            ),
            evans.PitchHandler(evans.Sequence.range(-13, 13)),
            abjad.glissando,
            abjad.Dynamic("f"),
            evans.Attachment(
                abjad.bundle(
            ...
            evans.Attachment(
                abjad.bundle(
                    abjad.StartTextSpan(
                        left_text=abjad.Markup(r'\markup \upright { flauntando }'),
                        style=r"solid-line-with-arrow",
                        command=r"\startTextSpanOne",
                    ),
                    r"- \tweak staff-padding 3",
    ...
    time_signatures=cairn.signatures_21,
    clef_handlers=None,
