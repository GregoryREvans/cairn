...
maker = evans.SegmentMaker(
    ...
    name_staves=True,
    fermata_measures=cairn.fermata_measures_29,
    commands=[
        # evans.attach(
        #     "Global Context",
        ...
        evans.MusicCommand(
            ...
            evans.tuplet(
                ...
                preprocessor=evans.make_preprocessor(quarters=True, fuse_counts=[1, 2, 1, 2, 1, 1, 1, 1, 1], split_at_measure_boundaries=True),
                pre_commands=[
                    lambda _: rmakers.force_rest(
                        abjad.select.get(
                            abjad.select.tuplets(_), abjad.index([1, 3, 6, 8], 13)
                        )
                    ),
                    # lambda _: rmakers.force_rest(
                    #     abjad.select.get(
            ...
            evans.ArticulationHandler(["tongue #4"]),
            evans.BendHandler([6, 4, 8, -7, -9]),
        ...
        evans.MusicCommand(
            ("cello voice", (0, 6)),
            evans.note(),
            evans.PitchHandler([[-24 + 5.5, -17 + 5.5, -10 + 5.5, -3 + 5.5], -9.5 + 5, -9 + 5, -7 + 5, -10 + 5, -11 + 5]),
            abjad.tie,
            # evans.Attachment(
            #     abjad.Glissando(),
            #     selector=lambda _: abjad.select.leaf(_, 1),
            # ),
            lambda _: [abjad.attach(abjad.Glissando(), leaf) for leaf in abjad.select.leaves(_)[1:]],
            evans.Attachment(
    ...
    time_signatures=cairn.signatures_29,
    clef_handlers=None,
